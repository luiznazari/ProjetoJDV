...
import br.edu.unoesc.logica.Partida.Jogada;
import br.edu.unoesc.modelo.Caractere;
import br.edu.unoesc.modelo.Jogador;
import br.edu.unoesc.modelo.JogadorHumano;
...
public class PartidaTest {
	...
	public void deveIntercalarJogadas() {
		...
		assertEquals(2, Arrays.asList(partida.getJogadas()).stream().filter(j -> j != null).count());
	}
